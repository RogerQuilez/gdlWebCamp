<?php include_once 'includes/templates/header.php'; ?> <!-- Incluye un template en la página web-->
  ...
  <section class="programa">
    <div class="contenedor-video">
      <video autoplay loop poster="bg-talleres.jpg">
        <source src="video/video.mp4" type="video/mp4"> <!--Añadir un video a tu página web-->
    ...
    <div class="contenido-programa">
      <div class="contenedor">
        <div class="programa-evento">
          ...
          <?php
            do { //Esto es necesario para hacer un multi Query
      ...
      <div class="testimonial">
        <blockquote> <!--Para Testimoniales-->
          ...
          <footer class="info-testimonial clearfix">
            ...
            <cite>Juan Preciado Alarcón <span> Diseñador en @prisma</span></cite>
          </footer>
        </blockquote>
      </div><!--.Testimonial-->
